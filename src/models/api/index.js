...
export default class API {
	 ...
	 *
	 * @return {Promise<object>} The server keys data
	 */
	 ...
	 * @return {Promise<object>} The newly created server key data.
	 */
	static async createNewServerKey({ name, description, access }) {
		const response = await request({
			method: "POST",
	 ...
	 * @return {Promise<object>} The regenerated secret token data.
	 */
